    ...
    return (
      <AppShell>
        <EmptyState
          ...
          description="Las fuentes de todos los cuadernos aparecerán aquí"
        />
      </AppShell>
    )
  }
  ...
  return (
    <AppShell>
      ...
      <ConfirmDialog
        ...
        description={`¿Estás seguro de que deseas eliminar "${deleteDialog.source?.title || 'esta fuente'}"? Esta acción no se puede deshacer.`}
